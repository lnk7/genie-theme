<template>
    <div style="text-align: center;">
        <a href="/checkout" style="display: inline-block; position: relative; color: white;">
            <div>
                <svg
                        version="1.1"
...
export default {
    ...
    mounted() {
        ...
        document.addEventListener('reload_cart_count', function () {
            console.log('oi');
            self.refresh();
        }, false);
